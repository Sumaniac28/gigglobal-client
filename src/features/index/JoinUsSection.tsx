...
const JoinUsSection:FC = ():ReactElement => {
  return (
    <section className="w-full min-h-[60vh] flex items-center justify-center px-6 py-12">
  <div className="max-w-4xl w-full text-center p-6 sm:p-10 bg-gradient-to-r from-[#14B8A6] to-[#0F766E] rounded-3xl shadow-lg border border-[#E5E7EB]">
    {/* Heading */}
