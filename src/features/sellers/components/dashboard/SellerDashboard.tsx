...
const SellerDashboard: FC = (): ReactElement => {
  ...
  return (
    <div className="container mx-auto px-2 md:px-0 bg-[#F9FAFB] text-[#111111]">
      <div className="mt-10 flex flex-col justify-between gap-y-4">
        ...
        <div className="self-end">
          <Button
            ...
            className="w-full rounded-md text-center text-xs font-bold text-[#14B8A6] hover:text-[#0F766E] focus:outline-none md:bg-[#14B8A6] md:px-3 md:py-2 md:text-sm md:text-white hover:md:bg-[#0F766E] hover:md:text-white"
