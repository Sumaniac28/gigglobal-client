        ...
        <div className="mb-6 px-3 md:mb-16">
          ...
          <div className="mb-4 mt-2 flex items-center">
            <TextInput
              ...
              className="h-4 w-4 rounded border-[#E5E7EB] bg-gray-100 text-[#14B8A6]"
            ...
            />
            <label htmlFor="default-checkbox" className="ml-2 text-sm font-normal text-[#4B5563]">
              I am currently working here
            </label>
          </div>
          <div className="mb-5 flex items-center">
            <TextAreaInput
              className="block w-full rounded border border-[#E5E7EB] p-2.5 text-sm text-[#111111] focus:outline-none focus:ring-[#14B8A6]"
