    ...
    <>
      ...
      <div className="border-[#E5E7EB] mb-8 border">
        <div className="flex border-b border-[#E5E7EB] px-4 py-2">
          <h4 className="font-bold text-[#111111]">About The Seller</h4>
        </div>
        <div className="mb-0 px-4 pt-2">
          <div className="flex flex-col gap-y-3 md:flex-row md:gap-x-2">
            ...
            <div className="flex flex-col self-center">
              ...
              >
                <span className="text-base font-bold text-[#111111] md:mb-5">{gig.username}</span>
              </Link>
              <span className="flex self-center text-sm text-[#4B5563] md:block md:self-start">{seller.oneliner}</span>
              <div className="flex w-full justify-center pt-1 md:justify-start">
                <div className={`flex w-full justify-center md:justify-start ${seller.ratingsCount === 0 ? 'gap-x-[5.8rem]' : 'gap-x-5'}`}>
                  <div className="flex w-full justify-center gap-x-1 md:justify-start">
                    ...
                    <div className="ml-2 mt-[1px] flex gap-1 text-sm text-[#4B5563]">
          ...
          <div className="grid grid-cols-1 gap-y-4 lg:grid-cols-2 text-[#4B5563]">
            <div className="flex flex-col">
              <span>From</span>
              <span className="font-bold text-[#111111]">{seller.country}</span>
            </div>
            <div className="flex flex-col">
              <span>Member since</span>
              <span className="font-bold text-[#111111]">{TimeAgo.formatDateToMonthAndYear(`${seller.createdAt}`)}</span>
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              <span>Languages</span>
              <div className="flex flex-wrap text-[#111111]">
                {seller?.languages &&
